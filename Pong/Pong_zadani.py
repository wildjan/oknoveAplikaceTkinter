...
def update_canvas():
    ...
    # move paddles    
    canvas.coords(paddle1, (HALF_PAD_WIDTH, paddle1_pos - HALF_PAD_HEIGHT,\
        HALF_PAD_WIDTH, paddle1_pos + HALF_PAD_HEIGHT))
    canvas.coords(paddle2, (WIDTH - HALF_PAD_WIDTH, paddle2_pos - HALF_PAD_HEIGHT,\
